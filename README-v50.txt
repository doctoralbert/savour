...
- Contact page uses the intended address contact@savour.app. The mailbox itself must still be created with the email/domain provider; Savour cannot provision an external mailbox.
